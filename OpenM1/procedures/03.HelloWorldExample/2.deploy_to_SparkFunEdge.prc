...
ubuntu1604 run "python3 tensorflow/lite/micro/tools/make/downloads/AmbiqSuite-Rel2.2.0/tools/apollo3_scripts/create_cust_image_blob.py --bin tensorflow/lite/micro/tools/make/gen/sparkfun_edge_cortex-m4/bin/hello_world.bin --load-address 0xC000 --magic-num 0xCB -o main_nonsecure_ota --version 0x0"
0
$4
