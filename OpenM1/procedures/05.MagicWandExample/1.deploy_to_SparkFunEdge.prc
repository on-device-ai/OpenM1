...
$1
Compile the binary
ubuntu1604 run "make -f tensorflow/lite/micro/tools/make/Makefile TARGET=sparkfun_edge magic_wand_bin"
0
$2
...
ubuntu1604 run "python3 tensorflow/lite/micro/tools/make/downloads/AmbiqSuite-Rel2.2.0/tools/apollo3_scripts/create_cust_image_blob.py --bin tensorflow/lite/micro/tools/make/gen/sparkfun_edge_cortex-m4/bin/magic_wand.bin --load-address 0xC000 --magic-num 0xCB -o main_nonsecure_ota --version 0x0"
0
$4
